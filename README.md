...
![Empty canvas](docs/screenshots/overview/empty-canvas.png)
*App on first launch — empty canvas with catalog panel open.*

![Loaded board](docs/screenshots/overview/loaded-board.png)
...
### Boards — list view
![Boards list](docs/screenshots/catalog/boards-list.png)

### Boards — thumbnail view
![Boards image view](docs/screenshots/catalog/boards-image-view.png)

### Devices
![Devices](docs/screenshots/catalog/devices.png)

### Devices — filtered by type
![Devices filtered](docs/screenshots/catalog/devices-filtered.png)
...
![Custom item form](docs/screenshots/catalog/custom-item-form.png)
...
![Selection toolbar](docs/screenshots/canvas/selection-toolbar.png)
...
![X-ray mode](docs/screenshots/canvas/xray-mode.png)
*X-ray makes all objects 50% transparent for easier wiring inspection.*

### Grid

![Grid](docs/screenshots/canvas/grid-mm.png)
...
![Drawing mode](docs/screenshots/cables/drawing-mode.png)
...
![Add cable modal](docs/screenshots/cables/add-cable-modal.png)
...
![Cable toolbar](docs/screenshots/cables/cable-toolbar.png)
...
![Cable terminals](docs/screenshots/cables/cable-terminals.png)
...
![Visibility dimmed](docs/screenshots/cables/visibility-dimmed.png)
...
### Collapsed
![Side controls collapsed](docs/screenshots/ui/side-controls-collapsed.png)

### Expanded (all groups open)
![Side controls expanded](docs/screenshots/ui/side-controls-expanded.png)
...
![3D view HQ](docs/screenshots/3d/3d-view-hq.png)
*High-quality 3D view with floor, shadows and specular highlights.*

![3D view LQ](docs/screenshots/3d/3d-view-lq.png)
...
![Ruler rectangle](docs/screenshots/tools/ruler-rectangle.png)
*Rectangle ruler: drag to measure width, depth and diagonal.*

![Line ruler](docs/screenshots/tools/ruler-line.png)
...
![Component list](docs/screenshots/modals/component-list.png)
...
![Settings](docs/screenshots/modals/settings.png)
...
![GPT prompt](docs/screenshots/modals/gpt-prompt.png)
...
![Confirmation dialog](docs/screenshots/modals/confirmation.png)
...
React 18, Vite, TypeScript, CSS3.

---

## Legal

For personal, non-commercial use. All brands and product names are property of their respective owners. Data can contain errors; verify before purchasing or relying on measurements.
