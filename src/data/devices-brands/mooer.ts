...
const WDH_MOOER_EXPLINE: [number, number, number] = [55, 92, 58];
...
const mooerDevices: Omit<DeviceTemplate, "id" | "name" | "brand">[] = [
  ...
  { type: "multifx", model: "GE200 Plus", wdh: WDH_MOOER_GE200_PLUS, image: "mooer-ge200plus.png" },
  { type: "multifx", model: "GE250", wdh: WDH_MOOER_GE250, image: "mooer-ge-250.png" },
