...
const dunlopDevices: Omit<DeviceTemplate, "type" | "brand" | "id" | "name">[] =
  [
    {
...
export const DUNLOP_DEVICE_TEMPLATES: DeviceTemplate[] = dunlopDevices.map(
  (d) => ({
    ...d,
    name: `Dunlop ${d.model}`,
    id: deviceId("dunlop", d.model),
    type: "pedal",
    brand: "Dunlop",
    image: "dunlop/" + d.image,
  })
);
