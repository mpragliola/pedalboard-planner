...
export const BOARD_TEMPLATES: BoardTemplate[] = [
  // Pedaltrain (images in /images/boards/pedaltrain/)
  { id: 'board-pedaltrain-nano', type: 'classic', brand: 'Pedaltrain', model: 'Nano', name: 'Pedaltrain Nano', width: 381, depth: 140, height: 35, color: 'rgb(60, 60, 60)', image: '/images/boards/pedaltrain/pedaltrain-nano.png' },
  { id: 'board-pedaltrain-nano-plus', type: 'classic', brand: 'Pedaltrain', model: 'Nano+', name: 'Pedaltrain Nano+', width: 457, depth: 140, height: 35, color: 'rgb(60, 60, 60)', image: '/images/boards/pedaltrain/pedaltrain-nano-plus.png' },
  { id: 'board-pedaltrain-nano-max', type: 'classic', brand: 'Pedaltrain', model: 'Nano Max', name: 'Pedaltrain Nano Max', width: 711, depth: 140, height: 35, color: 'rgb(60, 60, 60)', image: '/images/boards/pedaltrain/pedaltrain-nano-max.png' },
  { id: 'board-pedaltrain-metro-16', type: 'classic', brand: 'Pedaltrain', model: 'Metro 16', name: 'Pedaltrain Metro 16', width: 406, depth: 203, height: 35, color: 'rgb(60, 60, 60)', image: '/images/boards/pedaltrain/pedaltrain-metro-16.png' },
  { id: 'board-pedaltrain-metro-20', type: 'classic', brand: 'Pedaltrain', model: 'Metro 20', name: 'Pedaltrain Metro 20', width: 508, depth: 203, height: 35, color: 'rgb(60, 60, 60)', image: '/images/boards/pedaltrain/pedaltrain-metro-20.png' },
  { id: 'board-pedaltrain-metro-24', type: 'classic', brand: 'Pedaltrain', model: 'Metro 24', name: 'Pedaltrain Metro 24', width: 609, depth: 203, height: 35, color: 'rgb(60, 60, 60)', image: '/images/boards/pedaltrain/pedaltrain-metro-24.png' },
  { id: 'board-pedaltrain-metro-max', type: 'classic', brand: 'Pedaltrain', model: 'Metro Max', name: 'Pedaltrain Metro Max', width: 711, depth: 203, height: 76, color: 'rgb(60, 60, 60)', image: '/images/boards/pedaltrain/pedaltrain-metro-max.png' },
  { id: 'board-pedaltrain-classic-jr', type: 'classic', brand: 'Pedaltrain', model: 'Classic JR', name: 'Pedaltrain Classic JR', width: 457, depth: 317, height: 89, color: 'rgb(60, 60, 60)', image: '/images/boards/pedaltrain/pedaltrain-classic-jr.png' },
  { id: 'board-pedaltrain-classic-1', type: 'classic', brand: 'Pedaltrain', model: 'Classic 1', name: 'Pedaltrain Classic 1', width: 559, depth: 317, height: 89, color: 'rgb(60, 60, 60)', image: '/images/boards/pedaltrain/pedaltrain-classic-1.png' },
  { id: 'board-pedaltrain-classic-2', type: 'classic', brand: 'Pedaltrain', model: 'Classic 2', name: 'Pedaltrain Classic 2', width: 609, depth: 317, height: 89, color: 'rgb(60, 60, 60)', image: '/images/boards/pedaltrain/pedaltrain-classic-2.png' },
  { id: 'board-pedaltrain-classic-3', type: 'classic', brand: 'Pedaltrain', model: 'Classic 3', name: 'Pedaltrain Classic 3', width: 610, depth: 406, height: 89, color: 'rgb(60, 60, 60)', image: '/images/boards/pedaltrain/pedaltrain-classic-3.png' },
  { id: 'board-pedaltrain-classic-pro', type: 'classic', brand: 'Pedaltrain', model: 'Classic Pro', name: 'Pedaltrain Classic Pro', width: 813, depth: 406, height: 89, color: 'rgb(60, 60, 60)', image: '/images/boards/pedaltrain/pedaltrain-classic-pro.png' },
  { id: 'board-pedaltrain-jr-max', type: 'classic', brand: 'Pedaltrain', model: 'JR Max', name: 'Pedaltrain JR Max', width: 711, depth: 318, height: 89, color: 'rgb(60, 60, 60)', image: '/images/boards/pedaltrain/pedaltrain-jr-max.png' },
  { id: 'board-pedaltrain-novo-18', type: 'classic', brand: 'Pedaltrain', model: 'Novo 18', name: 'Pedaltrain Novo 18', width: 457, depth: 368, height: 89, color: 'rgb(60, 60, 60)', image: '/images/boards/pedaltrain/pedaltrain-novo-18.png' },
  { id: 'board-pedaltrain-novo-24', type: 'classic', brand: 'Pedaltrain', model: 'Novo 24', name: 'Pedaltrain Novo 24', width: 609, depth: 368, height: 89, color: 'rgb(60, 60, 60)', image: '/images/boards/pedaltrain/pedaltrain-novo-24.png' },
  { id: 'board-pedaltrain-novo-32', type: 'classic', brand: 'Pedaltrain', model: 'Novo 32', name: 'Pedaltrain Novo 32', width: 813, depth: 368, height: 89, color: 'rgb(60, 60, 60)', image: '/images/boards/pedaltrain/pedaltrain-novo-32.png' },
  { id: 'board-pedaltrain-terra-42', type: 'classic', brand: 'Pedaltrain', model: 'Terra 42', name: 'Pedaltrain Terra 42', width: 1067, depth: 368, height: 89, color: 'rgb(60, 60, 60)', image: '/images/boards/pedaltrain/pedaltrain-terra-42.png' },
  { id: 'board-pedaltrain-xd-18', type: 'classic', brand: 'Pedaltrain', model: 'XD-18', name: 'Pedaltrain XD-18', width: 457, depth: 445, height: 89, color: 'rgb(60, 60, 60)', image: '/images/boards/pedaltrain/pedaltrain-xd-18.png' },
  // RockBoard
