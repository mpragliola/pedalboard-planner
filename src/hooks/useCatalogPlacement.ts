...
import { createCustomObject, createObjectFromTemplate, modeToSubtype, type CustomItemParams } from "../lib/template/templateHelpers";
import { visibleViewportPlacement } from "../lib/placementStrategy";
import type { ObjectIdGenerator } from "../lib/object/objectIdGenerator";
